...
export const e1m0: Dungeon = {
  ...
  layout: {
    ...
    monsters: [
      createMonster(MonsterType.ORC, Colour.Green, 6, 9),
      createMonster(MonsterType.ORC, Colour.Yellow, 8, 10),
      createMonster(MonsterType.ORC, Colour.Red, 7, 5),
      createMonster(MonsterType.ORC, Colour.Red, 9, 3),
